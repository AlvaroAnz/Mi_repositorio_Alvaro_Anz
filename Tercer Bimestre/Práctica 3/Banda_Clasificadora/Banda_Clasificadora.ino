...
void verificacion() { //DDependiendo de los datos captados
  if (resultado_rojo > resultado_azul && resultado_rojo > resultado_verde) { //Si el resultado rojo es el dominante
